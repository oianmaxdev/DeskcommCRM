...
| `meta-capi-lead.architecture.json` | Meta CAPI Lead (migration 0382) — prova causal no nascimento automático, `lead.created` compartilhado, claim/lease no ledger e coexistência de Lead + Purchase sem confundir `ctwa_clid` com `ad_id` |
